...
const routes: Routes = [
  ...
  {path: ':name/fleets', component: FleetPageComponent},
  {path: 'add-fleet', component: AddFleetComponent},
  {path:':name/search/:searchTerm', component:FleetPageComponent},
  ...
  {path: ':name/fleet-maintainance-list', component: MaintainanceListComponent},
  {path: ':name/remove-page/:fleetNumber', component: RemoveFormComponent},
  {path: ':name/booking-page/:fleetNumber', component: FleetbookingComponent},
